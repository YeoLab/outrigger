...
[![Build Status](https://travis-ci.org/YeoLab/outrigger.svg?branch=master)](https://travis-ci.org/YeoLab/outrigger)[![codecov](https://codecov.io/gh/YeoLab/outrigger/branch/master/graph/badge.svg)](https://codecov.io/gh/YeoLab/outrigger)[![PyPI versions](https://img.shields.io/pypi/v/outrigger.svg)](https://pypi.python.org/pypi/outrigger)[![Python Compatibility](https://img.shields.io/pypi/pyversions/outrigger.svg)]()
